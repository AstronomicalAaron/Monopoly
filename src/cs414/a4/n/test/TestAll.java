...
@RunWith (Suite.class)
@Suite.SuiteClasses({BankTest.class, BoardTest.class, ChatMessageTest.class,
	DieTest.class, MonopolyTest.class, OwnerTest.class , PlayerTest.class, TileTest.class, 
	TokenTest.class})
